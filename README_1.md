...
A production-style **Retrieval-Augmented Generation (RAG)** system for querying complex enterprise documents — financial filings, contracts, technical reports — with **role-based access control**, **hybrid retrieval**, and **multimodal document understanding**.
